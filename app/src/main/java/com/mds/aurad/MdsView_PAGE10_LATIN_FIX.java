...
public class MdsView extends View {
    ...
    protected void onDraw(Canvas c) {
        ...
        if (page == 10) {
            // Halaman 10:
            // - Arab tetap seperti yang sudah benar/disetujui.
            // - Latin hanya memotong bagian bawah gambar PNG yang berisi tombol lama.
            //   Semua teks Latin di atas tombol tetap ditampilkan utuh.
            drawImagePage(c, latin ? page10Latin : page10Arab, latin ? .70f : 1.00f);
            return;
        }
