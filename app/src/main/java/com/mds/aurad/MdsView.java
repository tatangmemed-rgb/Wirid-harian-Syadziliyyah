...
public class MdsView extends View {
    ...
    private Bitmap load(Context c, int id) {
        // Hindari density-scaling otomatis pada PNG. Pada HP density tinggi,
        // scaling ini dapat memperbesar bitmap beberapa kali dan menyebabkan
        // OutOfMemoryError/force-close saat aplikasi baru dibuka.
    ...
    protected void onDraw(Canvas c) {
        ...
        // HALAMAN 10
        // Arab tetap seperti versi yang sudah benar.
        // Latin memakai crop .88 agar hanya bagian tombol lama PNG yang dibuang,
        // sedangkan seluruh teks sampai baris terakhir "AS SAGHURI." tetap utuh.
        // Tombol aktif tetap memakai tombol aplikasi dari drawFooter().
        if (page == 10) {
            drawImagePage(c, latin ? page10Latin : page10Arab, latin ? .88f : 1.00f);
            return;
        }
